...
<option value="page"<?php if($type == "page") echo " selected"; ?>>Page</option>
<option value="port"<?php if($type == "port") echo " selected"; ?>>Port</option>
</select>
...
<script>
    function setVisibility() {
        ...
        if(type == 'page') {
            ...
            document.getElementById('lbl2').innerHTML = 'Text';
    ...
    document.getElementById('type').onchange = function(){setVisibility()};
    setVisibility();
</script>
