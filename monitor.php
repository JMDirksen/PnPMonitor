...
<div id="button-bar">
  ...
  <div>
    <div class="button">
      <a href="action.php?delete=<?php echo $monitorid; ?>" onClick="return confirm('Delete monitor?');">
        Delete
      </a>
    </div>
    <div class="button">
      <a href="?p=edit&id=<?php echo $monitorid; ?>">
        Edit
      </a>
    </div>
  </div>
...
<div id="lastresult">
  <div>Last result</div>
  <div class="row">
    <div class="label">Time:</div><span><?php echo $time; ?></span>
  </div>
  <div class="row">
    <div class="label">Response:</div><span><?php echo $result; ?></span>
  </div>
</div>
<div id="graph">
  <div>Graph</div>
  ...
  <div id="chart_div" onclick="window.location.href='?p=graph&id=<?php echo $monitorid; ?>';">
  </div>
</div>
